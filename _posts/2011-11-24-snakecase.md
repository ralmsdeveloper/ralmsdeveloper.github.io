...
<div style="text-align: justify;">
Foi a necessidade que eu tive e a improdutividade de ficar digitando uma (" aspas duplas) em torno dos campos em minhas consultas <strong>PostgreSQL</strong>, isso mesmo
