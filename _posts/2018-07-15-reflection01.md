...
Este artigo foi apenas o primeiro passo para série completa que está por vir, iremos iniciar com o básico e iremos evoluir para o complexo, espero que gostem, deixem sugestões do que gostariam de ver nos próximos, alguem exemplo do dia-a-dia de vocês.
</div>
## 7 - Exemplo completo
```csharp
using System;
