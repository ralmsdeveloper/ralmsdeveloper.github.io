...
```
## 4 - Recuperar propriedades da classe
Veja como é simples recuperar as propriedades de uma calsse usando Reflection, o método <strong>GetProperties()</strong> nos devolve um array do tipo <strong>PropertyInfo[]</strong> que contém todas propriedades da classe, que por sua vez contém todas informações da propriedade como nome e tipo.
<br>
Exemplo:
```csharp
...
## 5 - Invocando método com Reflection 
