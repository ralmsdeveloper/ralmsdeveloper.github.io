...
o controle de tudo ou quase tudo que acontece no banco. é imprescindível que não tenhamos esse controle. É uma forma de saber se as consultas estão sendo geradas corretamente, mas entra oportunidade iremos falar mais sobre isso, enfim ..., como o objetivo maior de nosso artigo é mostrar como visualizar/capturar os comandos enviados para o banco, nada mais justo que utilizarmos o <strong>EntityFramework Core</strong> para isso 😊.
<br><br>
