...
<div style="text-align: justify;">
Classe com métodos para produzir e consumir dados do canal,
o método <b>Enqueue</b> produz uma mensagem no canal, <b>Consumer</b> obtem a mensagem do canal, nosso método <b>StartConsumers</b> inicializa 6 consumidores, é uma estratégia para escalar e extrair o melhor do canal:
 </div>
```csharp
...
Classe com métodos para executar testes de performance, o método <b>GetProdutos</b> é para abstrair o uso de um arquivo real.
```csharp
[MemoryDiagnoser]
...
## Benchmark
<div style="text-align: justify;">
Como podemos observar temos um ganho enorme de performance, ao utilizar o padrão producer-consumer, com isso aumentamos a capacidade de processamentos em nossa aplicação.
</div>
```
