...
## Benchmark
<div style="text-align: justify;">
Como podemos observar temos um ganho muito significativo de performance, ao utilizar o padrão <b>producer-consumer</b>, com isso aumentamos a capacidade de processamentos em nossa aplicação, mas esse não é o X da questão, e sim a utilização do <b>Channels</b>.
</div>
```
...
## Considerações
<div style="text-align: justify;">
O que me motivou a escrever esse artigo é que em nosso dia-a-dia passamos por situações que às vezes precisamos escrever muito código, mas existem inúmeras implementações nativas que podemos utilizar e que resolvem muito bem determinadas demandas.
<br /><br />
