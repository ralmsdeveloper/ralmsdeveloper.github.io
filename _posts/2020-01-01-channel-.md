...
<br /> <br /> 
<b>Channel&#60;T&#62;</b> é uma classe abstrata genérica, e para instanciar precisamos usar alguns métodos da classe estática <b>Channel</b>.
</div>
![Métodos]({{site.url}}{{site.baseurl}}/assets/images/channel/metodos.png)
<div style="text-align: justify;">
Irei abordar apenas dois deles, na continuação deste artigo iremos fazer um deep-dive melhor, sendo assim os métodos básicos são:<br />
