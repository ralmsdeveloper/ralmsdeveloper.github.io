...
<br /> <br />
<b>Channel<´T´></b> é uma classe abstrata genérica, e para instanciar precisamos usar alguns métodos da classe estática <b>Channel</b>, irei abordar apenas dois deles, na continuação deste artigo iremos fazer um deep-dive melhor, sendo assim os métodos básicos são:<br />
<b>CreateBounded<´T´>(int capacity):</b><br />
Cria um canal delimitando a capacidade de objetos que podem ser alocados.<br /><br />
<b>CreateUnbounded<´T´>():</b><br />
Cria um canal sem limitar a capacidade de objetos que podem ser alocados, ao usar método deve-se tomar muito cuidado, sabemos que recursos da máquina não são finitos, com isso você pode sobrecarregar a memória, mas falaremos mais sobre isso na continuação deste artigo.
<br /><br />
