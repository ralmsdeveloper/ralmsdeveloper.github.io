...
Classe com métodos para produzir e consumir dados do canal, nosso método <b>StartConsumers</b> inicializa 6 consumidores, falaremos logo mais sobre ela:
```csharp
