...
<br /> 
<code>Channel</code> é uma classe abstrata genérica, e para instanciar precisamos usar alguns métodos da classe estática <b>Channel</b>, irei abordar apenas dois deles, na continuação deste artigo iremos fazer um deep-dive melhor, sendo assim os métodos básicos são:<br />
<code>CreateBounded<T>(int capacity):</code><br />
Cria um canal delimitando a capacidade de objetos que podem ser alocados.<br />
<code>CreateUnbounded<T>():</code><br />
